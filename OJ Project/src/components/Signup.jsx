...
function Signup() {
  ...
  return (
    <div className="min-h-screen flex">
      <div className="flex items-center w-full justify-center mt-10 p-8">
        <div className="max-w-md space-y-4 rounded-lg p-10 shadow-xl/30">
          ...
          <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
            ...
            {errors.password && (
             ...
             <input
              ...
              className='w-full p-2 border border-gray-300 rounded-md focus:outline-none'
              {...register("confirmpassword", { required: {value:true, message:"Password is required"}})}
            />
            {errors.confirmpassword && (
              <p>{errors.confirmpassword.message}</p>
            )}
            <input className='w-full bg-blue-400 p-2 border border-gray-300 rounded-md' type="submit" />
          </form>
